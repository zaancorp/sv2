...
class personaje(pygame.sprite.Sprite):
    ...
    def __init__(self, x, y, imagen, frames):
        ...
        self.dic_imagenes = {
            ...
            8: self.varios + "8.png",
            9: self.varios + "9.png",
            10: self.varios + "10.png",
            11: self.varios + "11.png",
            12: self.varios + "12.png",
            13: self.varios + "13.png",
            14: self.varios + "14.png",
            15: self.varios + "15.png",
            16: self.varios + "16.png",
            17: self.varios + "17.png",
            18: self.varios + "18.png",
            19: self.varios + "19.png",
            20: self.varios + "20.png",
            21: self.varios + "21.png",
            22: self.varios + "22.png",
            23: self.varios + "23.png",
            24: self.varios + "24.png",
            25: self.varios + "25.png",
            26: self.varios + "26.png",
            27: self.varios + "27.png",
            28: self.varios + "28.png",
            29: self.varios + "29.png",
            30: self.varios + "30.png",
            31: self.varios + "31.png",
        }
        self.posx = x
        self.posy = y
        self.vel = 200
    ...
    def actualizar_rects(self):
        ...
        if self.izq:
            self.rect.left, self.rect.top = (
                self.posx + (self.ancho / 32) * 11,
                self.posy + 188,
            )
            self.rt_car.left, self.rt_car.top = (
                self.rect.left - (self.ancho / 4),
                self.posy + 188,
            )
        else:
            self.rect.left, self.rect.top = (
                self.posx + (self.ancho / 32) * 3,
                self.posy + 188,
            )
    ...
    def draw(self, surface):
        ...
        for spr in sprites:
            self.spritedict[spr] = surface_blit(
                spr.image, (spr.posx, spr.posy), spr.rect2
            )
